		...
		<form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.jiaoshiUuidNumber" type="text" v-model="ruleForm.jiaoshiUuidNumber" placeholder="工号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
	...
	export default {
		data() {
			return {
				...
				ruleForm: {
					jiaoshiUuidNumber: this.getUUID(),//数字
					username: '',
					password: '',
					jiaoshiName: '',
					jiaoshiPhoto: '',
		...
		methods: {
			...
			async onSubmitTap() {
				if ((!this.ruleForm.jiaoshiUuidNumber)) {
