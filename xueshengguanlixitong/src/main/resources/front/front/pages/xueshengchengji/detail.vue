                ...
                <view class="detail-content">
                    <view class="detail-list-item"
                        ...
                        <view class="lable"
                            ...
                            标题：</view>
                        <view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.xueshengchengjiName}}
                        </view>
                    </view>
                </view>
                <view class="time-content"
                    ...
                    <view class="content" :style='{"color":"#333","fontSize":"28rpx"}'>
                        <rich-text style="font-size: 33upx;line-height: 50upx;letter-spacing: 5upx;"
                                   :nodes="detail.xueshengchengjiContent"></rich-text>
                    </view>
                </view>
	...
	export default {
		...
		methods: {
			...
			async init() {
				...
				// 主图
				this.swiperList = this.detail.xueshengchengjiPhoto ? this.detail.xueshengchengjiPhoto.split(",") : [];
			},
